...
import cn.linkmore.ops.biz.service.WechatFansService;
 ...
 */
@Controller
@RequestMapping("/admin/biz/wechat_fans")
public class WechatFansController {
	...
	public void export( ReqWechatFansExcel bean,HttpServletResponse response,HttpServletRequest request){ 
