...
@Controller
@RequestMapping("/admin/biz/prefecture_ent")
public class PrefectureEntranceController {

	@Resource
	private PrefectureEntranceService prefectureEntranceService;
	...
	public ViewPage list(HttpServletRequest request, ViewPageable pageable) {
		return prefectureEntranceService.findPage(pageable);
	}

	@RequestMapping(value = "/save", method = RequestMethod.POST)
	@ResponseBody
	public ViewMsg save(HttpServletRequest request, ReqPrefectureEntrance ele) {
		ViewMsg msg = null;
		try {
			this.prefectureEntranceService.save(ele);
	...
	@ResponseBody
	public ViewMsg update(HttpServletRequest request, ReqPrefectureEntrance ele) {
		ViewMsg msg = null;
		try {
			this.prefectureEntranceService.update(ele);
	...
	public ViewMsg delete(@RequestBody List<Long> ids) {
		ViewMsg msg = null;
		try {
			this.prefectureEntranceService.delete(ids);
