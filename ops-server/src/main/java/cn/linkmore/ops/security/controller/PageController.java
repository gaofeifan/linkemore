...
import cn.linkmore.ops.security.service.PageService;
 ...
 */
@Controller
@RequestMapping("/admin/security/page")
public class PageController {
	...
	@ResponseBody
	public ViewMsg save(ReqPage page){
		ViewMsg msg = null;
		try {
	...
	@ResponseBody
	public ViewMsg update(ReqPage page){
		ViewMsg msg = null;
		try {
