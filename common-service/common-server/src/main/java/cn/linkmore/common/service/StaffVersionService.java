 ...
 * @Version  v2.0
 */
public interface StaffVersionService {
	 ...
	 * @Version  v2.0
	 */
	ResStaffAppVersion currentAppVersion(Integer appType, HttpServletRequest request);
	 ...
	 * @Version  v2.0
	 */
	void saveApp(ReqStaffAppVersion version);
	 ...
	 * @Version  v2.0
	 */
	void updateApp(ReqStaffAppVersion version);
