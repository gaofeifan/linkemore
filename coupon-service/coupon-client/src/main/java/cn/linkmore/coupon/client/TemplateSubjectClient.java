...
import cn.linkmore.coupon.client.hystrix.TemplateSubjectClientHystrix;
 ...
 *
 */
@FeignClient(value = "coupon-server", path = "/ops/coupon_template_subject", fallback=TemplateSubjectClientHystrix.class,configuration = FeignConfiguration.class)
public interface TemplateSubjectClient {
