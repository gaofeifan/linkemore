 ...
 *
 */
@FeignClient(value = "coupon-server", path = "/ops/coupon_template_condition", fallback=TemplateConditionClientHystrix.class,configuration = FeignConfiguration.class)
