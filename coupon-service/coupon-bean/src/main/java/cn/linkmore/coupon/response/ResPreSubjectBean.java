...
public class ResPreSubjectBean {
    ...
    private String oneselfReceive;
    private String otherReceive;
    private String payOneReceive;
    private String payTwoReceive;
    private String payThreeReceive;
    
	public String getPayOneReceive() {
		return payOneReceive;
	}

	public void setPayOneReceive(String payOneReceive) {
		this.payOneReceive = payOneReceive;
	}

	public String getPayTwoReceive() {
		return payTwoReceive;
	}

	public void setPayTwoReceive(String payTwoReceive) {
		this.payTwoReceive = payTwoReceive;
	}

	public String getPayThreeReceive() {
		return payThreeReceive;
	}

	public void setPayThreeReceive(String payThreeReceive) {
		this.payThreeReceive = payThreeReceive;
	}

	public String getOneselfReceive() {
		return oneselfReceive;
	}

	public void setOneselfReceive(String oneselfReceive) {
		this.oneselfReceive = oneselfReceive;
	}
