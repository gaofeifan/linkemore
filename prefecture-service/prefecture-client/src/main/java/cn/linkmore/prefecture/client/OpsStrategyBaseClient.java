...
import cn.linkmore.prefecture.client.hystrix.OpsStrategyBaseClientHystrix;
 ...
 *
 */ 
@FeignClient(value = "prefecture-server", path = "/ops/strategy", fallback=OpsStrategyBaseClientHystrix.class,configuration = FeignConfiguration.class)
public interface OpsStrategyBaseClient {
