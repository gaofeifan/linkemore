 ...
 */ 
@Component
public class OpsStrategyDateClientHystrix implements OpsStrategyDateClient {
	private  final Logger log = LoggerFactory.getLogger(this.getClass());

	@Override
	public int save(ReqStrategyDate reqStrategyBase) {
		log.info("prefecture service strategy save(Long reqStrategyBase) hystrix");
		return 0;
	}

	@Override
	public int update(ReqStrategyDate reqStrategyBase) {
	...
	public List<ResStrategyDate> findList(Map<String, Object> map) {
		...
		return new ArrayList<ResStrategyDate>();
	}
	@Override
