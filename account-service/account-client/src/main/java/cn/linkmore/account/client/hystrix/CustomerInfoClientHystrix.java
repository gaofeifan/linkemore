 ...
 */
@Component
public class CustomerInfoClientHystrix implements CustomerInfoClient {
	private  final Logger log = LoggerFactory.getLogger(this.getClass());
	@Override
	public ViewPage list(ViewPageable pageable) {
		log.info("account service CustomerInfo list(ViewPageable pageable) hystrix");
		return null;
	}

	@Override
	public List<ResCustomerInfoExport> getExportList(ReqCustomerInfoExport pageable) {
		log.info("account service CustomerInfo getExportList(ReqCustomerInfoExport pageable) hystrix");
		return null;
	}
