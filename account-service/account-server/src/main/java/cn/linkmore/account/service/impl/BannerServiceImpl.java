...
import cn.linkmore.account.dao.cluster.WalletBannerClusterMapper;
import cn.linkmore.account.dao.master.WalletBannerMasterMapper;
...
import cn.linkmore.account.service.BannerService;
...
public class BannerServiceImpl implements BannerService {
	...
	public void update(ReqWalletBanner b) {
		...
		this.walletBannerMasterMapper.updateByIdSelective(ban);
	}
	...
	public List<ResWalletBanner> selectList(String sql) {
		return this.walletBannerMapper.selectList(sql);
	}
