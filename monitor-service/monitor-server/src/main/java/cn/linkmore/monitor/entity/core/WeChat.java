package cn.linkmore.monitor.entity.core;
...
public class WeChat {
	...
	// 获取用户列表
	private static final String USER_LIST_URL = "https://api.weixin.qq.com/cgi-bin/user/get?access_token=%s";
	...
	// 模板消息
	private static final String TEMPLATE_MSG = "https://api.weixin.qq.com/cgi-bin/message/template/send?access_token=%s";
	...
	// 获取微信用户列表
	public static String getUserListUrl(String token) {
		return String.format(USER_LIST_URL, token);
	}
	...
	// 获取模板消息url
	public static String getTemplateMsg(String token) {
		return String.format(TEMPLATE_MSG, token);
	}
	 ...
	 * @throws Exception
	 */
	public static JSONObject uploadMedia(String mediaType, String filePath, String appId, String appSecret)
			throws Exception {
