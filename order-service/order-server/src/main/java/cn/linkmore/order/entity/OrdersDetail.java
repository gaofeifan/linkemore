...
public class OrdersDetail {
    ...
    public String getParkPrincipal() {
        return parkPrincipal;
    }

    public void setParkPrincipal(String parkPrincipal) {
        this.parkPrincipal = parkPrincipal == null ? null : parkPrincipal.trim();
    }
